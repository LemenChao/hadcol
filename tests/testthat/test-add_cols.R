...
test_that("where argument controls position", {
...
test_that("clear error for bad inputs", {
  expect_error(check_where("a"), "single number")
  expect_error(check_where(1:10), "single number")
